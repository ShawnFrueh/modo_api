...
class ImageMonitor:
    ...
    def imon_Image(self, imageToAnalyze, frameBufferToAnalyze, bufferIndex, x1, y1, x2, y2,
...
class RenderJob:
    ...
    def rjob_ProgressRenderPassEnd(self, frame, renderPassIndex, renderPassName, eye, frameBuffer,
                                   stats):
        pass
